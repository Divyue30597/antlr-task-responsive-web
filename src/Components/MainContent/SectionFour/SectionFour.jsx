      ...
      <div className="container">
        <div className="section-four-container">
          ...
          <div className="section-four-body">
            ...
            <p>
              Our community is a collaboration hub, where the best tech people
              and the right companies come together, helping each other to be
              the very best at business.
            </p>
          </div>
        </div>
      </div>
